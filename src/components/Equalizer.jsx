    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" onClick={onClose}>
      <div className="bg-white rounded-lg shadow-xl p-6 w-96 max-w-full mx-4" onClick={e => e.stopPropagation()}>
            ...
            <div key={band.freq} className="flex flex-col items-center">
              <div className="h-32 flex items-center">
                <input
                  ...
                  className="h-24 accent-blue-500"
                  style={{
              ...
              <span className="text-xs text-gray-400">{bands[index] > 0 ? '+' : ''}{bands[index]}dB</span>
            </div>
          ))}
        </div>
        ...
        <div className="flex items-center justify-between pt-4 border-t border-gray-200">
          <div>
            <div className="font-medium text-gray-800">Volume Normalization</div>
          ...
          <button
            ...
            className={`relative w-12 h-6 rounded-full transition ${
              normalization ? 'bg-blue-500' : 'bg-gray-300'
            }`}
          >
            <span
